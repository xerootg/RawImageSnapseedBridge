...
// Stub implementations when JXL support is disabled
...
// Always return false for JXL support
inline bool SupportsJXL (const dng_image &)
	{
	return false;
	}
...
// Stub JXL constants
#define JXL_COLOR_SPACE_GRAY 0
#define JXL_COLOR_SPACE_RGB 1
#define JXL_WHITE_POINT_D65 0
#define JXL_PRIMARIES_2100 0
#define JXL_TRANSFER_FUNCTION_SRGB 0

// Stub JxlColorEncoding structure with minimal members
...
class dng_jxl_decoder
	{
	public:
		void Decode (dng_host &, dng_stream &) {}
		AutoPtr<dng_image> fMainImage;
		bool fNeedBoxMeta = false;
	};
