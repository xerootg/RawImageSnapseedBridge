...
// Stub implementations when JXL is disabled

void dng_host::SetJXLEncodeSettings (const dng_jxl_encode_settings &)
	{
	// Stub - do nothing
	}

dng_jxl_encode_settings * dng_host::MakeJXLEncodeSettings (use_case_enum,
															const dng_image &,
															const dng_negative *) const
	{
	return nullptr;
	}
